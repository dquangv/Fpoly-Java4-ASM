...
if (userImage == null || userImage.isEmpty()) {
	userImage = "/fpoly/img/default_user_avatar.jpg";
} else {
    ...
    <g>
      <g id="youtube-paths_yt4">
        ...
        <path
						...
						</icon-shape></yt-icon-shape></yt-icon></a></li>
			</ul>
...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static"
	...
	<div class="modal-dialog">
		<div class="modal-content"
			style="background-color: #272727 !important; color: white !important">
			<div class="modal-header">
				<h1 class="modal-title fs-5" id="staticBackdropLabel">Tạo video</h1>
				<button type="button" class="btn-close" data-bs-dismiss="modal"
					aria-label="Close"
					style="display: flex !important; justify-content: center !important; align-items: center; background-color: gray !important;">
			...
			<form>
				<div class="modal-body">
					...
					<div class="mb-3">
						<label for="exampleInputEmail1" class="form-label">Mô tả</label> <input
							type="text" class="form-control" id="exampleInputEmail1"
							aria-describedby="emailHelp">
					</div>
					<div class="mb-3">
						<label for="exampleInputPassword1" class="form-label">Link
							video</label> <input type="password" class="form-control"
							id="exampleInputPassword1">
					</div>
					<div class="mb-3">
						<label for="imageFile" class="form-label">Hình ảnh video</label> <input
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary"
						data-bs-dismiss="modal" style="background-color: gray !important">Đóng</button>
					<button type="submit" class="btn btn-primary"
						style="background-color: #0d6efd !important;">Tạo</button>
				</div>
			</form>
