            ...
            <div class="row">
                <form class="form" ng-submit="login()">
                    ...
                    <div class="inputForm">
                        ...
                        <input type="text" class="input" ng-model="user.email" placeholder="Email">
                    </div>
                    ...
                    <div class="inputForm">
                        ...
                        <input type="password" class="input" ng-model="user.password" placeholder="********">
                    ...
                    <div class="flex-row">
                        ...
                        <a style="text-decoration: none;" href=""><span class="span" style="color: #ffffff;">Quên mật
                                khẩu?</span></a>
                    </div>
                    ...
                    <div class="flex-row">
                        <button class="btn1 google" style="background-color: #333232; border: 1px solid #1c1c1c; color: #eee;">
                ...
                C318.115,0,375.068,22.126,419.404,58.936z"></path>
                        ...
                        </button><button class="btn1 apple" style="background-color: #333232; border: 1px solid #1c1c1c; color: #eee;">
