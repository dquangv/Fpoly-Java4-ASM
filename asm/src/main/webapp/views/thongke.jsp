        ...
        <div class="row">
            <div class="col-12">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="likes-tab" data-bs-toggle="tab" href="#likes" role="tab"
                            aria-controls="likes" aria-selected="true">Thống kê lượt thích</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="user-likes-tab" data-bs-toggle="tab" href="#user-likes" role="tab"
                            aria-controls="user-likes" aria-selected="false">Danh sách người thích</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="user-shared-tab" data-bs-toggle="tab" href="#user-shared" role="tab"
                            aria-controls="user-shared" aria-selected="false">Danh sách chia sẻ</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="user-likes" role="tabpanel" aria-labelledby="user-likes-tab">
